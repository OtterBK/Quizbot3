const SERVER_SIGNAL = 
{
  ...
  APPLY_NEXT_QUESTION: 0x8F,     // 10001111 - 현재 제출할 문제 적용.
  SYNC_DONE: 0x86,               // 10000110 - 모든 세션 동기화 후 계속 진행.
  ...
  HOST_CHANGED: 0x8E,            // 10001110 - 호스트 변경됨.
};
...
const CLIENT_SIGNAL = 
{
  ...
  NEXT_QUESTION_GENERATED: 0x0E,    // 00001111 - 현재 문제 생성됨.
