...
Object.defineProperty(exports, "SeekStream", { enumerable: true, get: function () { return YouTube_1.SeekStream; } });
                        ...
                        ask.question('Enter your Redirect URL now : ', (url) => {
                            ...
                            ask.question('Enter your region code (2-letter country code) : ', (mar) => {
                                ...
                                ask.question('Paste the url which you just copied : ', async (url) => {
                                    ...
                                    const check = await (0, Spotify_1.SpotifyAuthorize)(spotifyData, file);
                                    if (check === false)
